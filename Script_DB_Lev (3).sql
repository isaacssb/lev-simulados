...
CREATE TABLE ALTERNATIVA_QUESTAO(
	...
	ALTERNATIVA_CORRETA VARCHAR(500),
...
ALTER TABLE QUESTAO ADD CONSTRAINT ID_ALTERNATIVA_FK FOREIGN KEY
	(ID_ALTERNATIVA) REFERENCES ALTERNATIVA_QUESTAO (ID_ALTERNATIVA); 
